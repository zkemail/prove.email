...
//           <Typography variant='h1' sx={{paddingBottom:'20px'}} >Projects using our ZK Libraries</Typography>
  ...
  return (
    <section className="min-h-screen bg-white">
      <div className='bg-black'>
        <div className="pt-20 text-center relative bg-cover bg-center" style={{ backgroundImage: `url(${sectionBackground})` }}>
          <Typography sx={{color:'white'}}>zk Email supports</Typography>
          ...
          <div className="relative mt-8 mx-auto w-2/3 max-w-2xl top-[30px]">
            <Paper
              sx={{borderRadius:'5px'}}
              component="form"
