...
const projects = [
  ...
  { name: 'DKIM Archive', tagline: 'archives over a million old DKIM keys and selectors for various domains', url: 'https://archive.prove.email/', description: 'A comprehensive archive of historical DKIM keys and selectors for domains.', zk_email_lib: true, zk_lib: false, on_chain: false, off_chain: true, made_by_us: true, logo: 'https://em-content.zobj.net/source/apple/354/card-file-box_1f5c3-fe0f.png', blogLink: 'https://archive.prove.email/about', githubLink: 'https://github.com/zkemail/archive.prove.email', twitterLink: 'https://x.com/zkemail' },
  ...
  return (
    <section style={{ background: theme.palette.background.default, height: '100%' }}>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <ActionCard topText='For Developers' light={true} title='Build Your Own' text='No trusted hardware. No trusted attestation servers. Only trust zero knowledge proofs, smart contracts, email, and DNS infrastructure. All open source MIT libraries.' buttonText='Docs' buttonLink='https://docs.prove.email' />
      </motion.div>
      <motion.div
        variants={fadeInAnimationVariants}
        initial='initial'
