        ...
        <div className='bg-white min-h-screen flex-col px-[8%]'>
          <SlideInDiv direction="left">
            <Box sx={{paddingY: '5%'}}>
                ...
                <Typography variant='h6' sx={{fontWeight: 'medium', color: '#000000', width:'60%'}}>
                  almost all emails are signed by the sending domain server using an algorithm called DKIM.
                </Typography>
                <Box sx={{padding: '10px', marginY:'2%', backgroundColor: '#1E1E1E', borderRadius: '10px', width: {xs:'100%', sm:'90%', md:'60%'}}}>
                  <Typography variant='h6' sx={{fontWeight: 'medium', color: '#ffffff'}}>
                    rsa_sign(sha256(from:..., to:..., subject:..., body hash,...), private key)
                  </Typography>
                </Box>
                <Typography variant='h6' sx={{fontWeight: 'medium', color: '#000000', paddingBottom:'5%'}}>
                    this lets us verify the sender, receiver, the subject, the body
                </Typography>
                <Accordion title='DKIM Resources' contents='DKIM: DomainKeys Identified Mail. An email authentication method designed to detect email spoofing.' >
