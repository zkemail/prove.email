...
1. **Create a Safe Wallet**
   ...
   <img src="/blog-media/email-account-recovery/safe-created.png" alt="Safe Created Successfully"/>
...
2. **Connect Your Safe**
   ...
   <img src="/blog-media/email-account-recovery/landing-page-safe-wallet-flow.png" alt="ZK Email Recovery Landing Page Safe Wallet Flow"/>
   ...
   <img src="/blog-media/email-account-recovery/wallet-connect-copy-to-clipboard.png" alt="ZK Email Recovery WalletConnect Copy to Clipboard"/>
   ...
   <img src="/blog-media/email-account-recovery/connect-safe-dapp.png" alt="ZK Email Recovery Connect Safe Dapp"/>
...
3. **Enable Email Recovery Module**
   ...
   <img src="/blog-media/email-account-recovery/enable-email-recovery-module.png" alt="ZK Email Recovery Enable Email Recovery Module"/>
...
4. **Confirm Transaction on Safe**
   ...
   <img src="/blog-media/email-account-recovery/confirm-safe-transaction.png" alt="ZK Email Recovery Confirm Transaction on Safe"/>
...
5. **Set Up Guardian**
   ...
   <img src="/blog-media/email-account-recovery/set-up-guardian-details.png" alt="ZK Email Recovery Set Up Guardian Step"/>
...
6. **Sign Transaction and Confirm Guardian**
   ...
   <img src="/blog-media/email-account-recovery/confirm-safe-guardian.png" alt="ZK Email Recovery Confirm Safe Guardian"/>
   ...
   <img src="/blog-media/email-account-recovery/email-confirmation.png" alt="ZK Email Recovery Email Confirmation"/>
...
1. **Initiate Recovery**
   ...
   <img src="/blog-media/email-account-recovery/recover-wallet-flow.png" alt="ZK Email Recovery Recover Wallet Flow"/>
   ...
   <img src="/blog-media/email-account-recovery/trigger-recovery.png" alt="ZK Email Recovery Trigger Recovery"/>
...
2. **Guardian Email Confirmation**
   ...
   <img src="/blog-media/email-account-recovery/guardian-email-confirmation.png" alt="ZK Email Recovery Guardian Email Confirmation"/>
...
3. **Complete Recovery**
   ...
   <img src="/blog-media/email-account-recovery/complete-recovery.png" alt="ZK Email Recovery Complete Recovery"/>
...
1. **Create Burner Wallet**
   ...
   <img src="/blog-media/email-account-recovery/burner-safe-flow.png" alt="ZK Email Recovery Burner Safe Flow"/>

   Connect your wallet as you would normally do by clicking **"Connect Wallet"** on the top right corner. 

   <img src="/blog-media/email-account-recovery/connect-wallet.png" alt="ZK Email Recovery Connect Wallet"/>

   Then type your email on the Guardian's Email input box and click **"Create burner wallet"**.

   <img src="/blog-media/email-account-recovery/create-burner-wallet.png" alt="ZK Email Recovery Create Burner Wallet"/>

   You have to confirm the transaction and sign the messages. This will generate a burner safe that will be used in the recovery process. 
...
2. **Confirm Guardian**
   ...
   <img src="/blog-media/email-account-recovery/confirm-burner-guardian.png" alt="ZK Email Recovery Confirm Burner Guardian"/>
...
1. **Initiate Recovery**
   ...
   <img src="/blog-media/email-account-recovery/trigger-recovery-button.png" alt="ZK Email Recovery Recover Step"/>
   ...
   <img src="/blog-media/email-account-recovery/recover-burner.png" alt="ZK Email Recovery Recover Step"/>

   After filling up the fields click on **"Trigger Recovery"**.

   <img src="/blog-media/email-account-recovery/recover-burner-triggered.png" alt="ZK Email Recovery Recover Step"/>
...
2. **Guardian Verification**
   ...
   <img src="/blog-media/email-account-recovery/recover-burner-email.png" alt="ZK Email Recovery Recover Step"/>
...
3. **Complete Recovery**
   ...
   <img src="/blog-media/email-account-recovery/final-step-recover-burner.png" alt="ZK Email Recovery Recover Step"/>
   
   This action will replace the current owner of the Safe with the new address you've specified during the recovery process.

   <img src="/blog-media/email-account-recovery/burner-flow-completed.png" alt="ZK Email Recovery Burner Flow Completed"/>
