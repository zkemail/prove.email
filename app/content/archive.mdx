...
**Table of Contents**
[Getting Selectors](#Getting-Selectors)
[The Scrape](#The-Scrape)
[The Hack](#The-Hack)
[The Reverse Engineer](#The-Reverse-Engineer) 
...
Signature 1: $$ m_1^d \mod n$$
Signature 2: $$ m_2^d \mod n$$

$$ m_1^{de} = m_1 mod n = m_1 + nk_1$$
$$ m_2^{de} = m_2 mod n = m_2 + nk_2$$

And then if we subtract the message from the total mod two, we can then calculate these two:
$$ nk_1$$
$$ nk_2$$

Then take their GCD to get n:
$$ gcd(nk_1, nk_2) = n$$
