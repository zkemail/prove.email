...
If you are trying to setup a new circuit for yourself, we recommend the full automated circuit generation tool at our [SDK Registry](https://registry-dev.zkregex.com) -- it automatically generates and deploys your circuit specifications with an automatic frontend demo, in as few as 5 minutes with no ZK expertise needed.
