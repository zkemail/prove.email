...
- **[zk-email/helpers](https://docs.prove.email/zk-email-verifier/packages/zk-email-helpers)**  -  helper functions to help generate and verify the inputs of the circuit

- **[zk-email/contracts](https://docs.prove.email/zk-email-verifier/packages/zk-email-contracts)**  -  contains the DKIM Registry for public domains (google, yahoo, etc)

- **[zk-email/circuits](https://docs.prove.email/zk-email-verifier/packages/zk-email-circuits)**  -  circuit templates that are used in creating your circuit
...
Now, let's generate the input for a zk-regex. You can do this manually with the V1 zk regex code on zkregex.com, or automatically with our V2 zk regex code on sdk.prove.email.
...
This guide provided just one example of a circuit you can build. For more examples and resources, you can check out the [zk-email verifier usage guide](https://docs.prove.email/zk-email-verifier/usage-guide) and the [Twitter Circuit Code](https://github.com/zkemail/proof-of-twitter).
