...
const PrivacyPolicy = () => {
  ...
  return (
    <Box sx={{ background: theme.palette.background.default, minHeight: '100vh', paddingY: 8 }}>
      <Container maxWidth="md">
        <Typography variant="h1" component="h1" gutterBottom sx={{ fontFamily: berkeleyOldStyle.style.fontFamily, marginBottom: 4 }}>
...
Company: Ivy Research, LLC <br/>
 <br/>
This Privacy Policy is designed to comply with privacy standards, including Google&apos;s OAuth requirements, ensuring that ZK Email accesses only the necessary data for its privacy-preserving features without retaining or exposing sensitive information.<br/>
        </Typography>
      </Container>
    </Box>
  );
