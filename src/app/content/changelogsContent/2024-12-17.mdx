...
#### SDK
- Ensured consistent casing and naming conventions across WASM bindings.
- Integrated admin deletion functionality for compiled blueprints within the [SDK](https://github.com/zkemail/zk-email-sdk-js).
...
- Protected the [blueprint creation page](https://registry.zk.email/create/new), requiring users to be logged in before proceeding.
- Adopted consistent casing standards for code and data handling.
