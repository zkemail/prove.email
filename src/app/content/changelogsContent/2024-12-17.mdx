...
- Successfully implemented initial DKIM signature verification
- Added support for regex pattern matching.

Learn more in the [RISC Zero repository](https://github.com/zkemail/r0-zkEmail).
