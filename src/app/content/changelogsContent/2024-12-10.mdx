...
If you want to learn more and start using the Email Transaction Builder, check out the new [quickstart guide](https://docs.zk.email/email-tx-builder/quickstart).
