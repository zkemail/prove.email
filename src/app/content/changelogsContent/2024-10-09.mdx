...
DKIM Archive:
- We have a draft blog post up explaining the [DKIM archive](https://zk.email/blog/archive)
...
- The main website now supports the new 1.4.1 safes, via both the UI and the permissionless.js burner wallet flow! Try them out at https://recovery.zk.email and look at our guide at https://zk.email/blog/account-recovery