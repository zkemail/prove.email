...
The generic relayer is now live on Sepolia! The generic relayer allows to integrate email-driven actions into applications by interacting with a specific API endpoint and it handles the email verification process automatically. https://docs.zk.email/email-tx-auth/
