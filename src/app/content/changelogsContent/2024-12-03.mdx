...
This week, we've made several improvements to our SDK, JWT Transaction Builder, and Email Transaction Builder. You can read more about them on the [docs](https://docs.zk.email).
...
- Added React & Next.js templates to docs https://docs.zk.email/zk-email-sdk/setup
