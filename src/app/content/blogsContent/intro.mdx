...
To see a detailed breakdown of our latest presentations, check out our [slides](http://slides.zk.email).

Try our identity demos on [Demos](https://zk.email/projects). Reach out to us if you want to help work to integrate these proofs into the proof of personhood ecosystem!

Try our wallet demo on testnet on [emailwallet.org](https://emailwallet.org). Read the docs for them on [emailwallet.org/docs](http://emailwallet.org/docs).

You can see our ecosystem as of March 2024 here:

<p align="center">
<img src="/zkemail_breakdown2.png" width="750" alt="zkemail-breakdown"/>
</p>
