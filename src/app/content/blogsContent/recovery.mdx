...
We partnered with John from the Wax team at PSE to develop an email account recovery demo, accessible here: [ZK Email Recovery Demo](https://recovery.prove.email). For detailed steps on integrating with the demo, please refer to the documentation provided [here](https://github.com/zkemail/email-recovery/).
...
* Email Account Recovery demo for Legacy Safes: [prove.email/recovery](https://recovery.prove.email). This will allow you to add a module to currently deployed safes (v1-v1.3), ahead of their 7579 upgrade (v1.4.1) in Q3 2024. 
