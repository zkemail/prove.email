...
- **[zk-email/helpers](https://zkemail.gitbook.io/zk-email/zk-email-verifier/packages/zk-email-helpers)**  -  helper functions to help generate and verify the inputs of the circuit

- **[zk-email/contracts](https://zkemail.gitbook.io/zk-email/zk-email-verifier/packages/zk-email-contracts)**  -  contains the DKIM Registry for public domains (google, yahoo, etc)

- **[zk-email/circuits](https://zkemail.gitbook.io/zk-email/zk-email-verifier/packages/zk-email-circuits)**  -  circuit templates that are used in creating your circuit
