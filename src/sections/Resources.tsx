...
const Resources = () => {
  ...
  const handleScroll = (event: { currentTarget: { scrollLeft: any; clientWidth: number; }; }) => {
    if (isSmallScreen) {
  ...
  return (
    <div>
      ...
      <p className="subtitle1 text-center mb-[50px]">Know about us from our recent blogs, talks and documentations</p>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    height: "100%",
                    zIndex: 2,
                    background: `linear-gradient(to bottom right, #141515 30%, ${resource.color})`,
                ...
                >
                  <div className="col-span-2">
                    <div className="flex items-center pt-4 py-3">
                      <div
                        ...
                        style={{ backgroundColor: resource.color, borderColor: resource.colorLight }}
                      ></div>
                      <p
                        className="pl-1 sm:pl-3 text-xs"
                        style={{ color: resource.colorLight }}
                      >
                  ...
                  <div className="col-span-2 flex items-end">
                    <div className="flex justify-between items-center w-full">
                      ...
                      <div className="w-1/3">
                        <p className="text-right text-xs" style={{color: resource.colorLight}}>
                          {resource.date}
                        </p>
                      </div>
                    </div>
        ...
        {!isSmallScreen && (
          <div className="flex justify-center space-x-4 mt-12">
            ...
            >
              Next
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                <path d="M9.93389 7.30936L5.55889 11.6844C5.51824 11.725 5.46998 11.7573 5.41688 11.7793C5.36377 11.8013 5.30684 11.8126 5.24936 11.8126C5.19187 11.8126 5.13495 11.8013 5.08184 11.7793C5.02873 11.7573 4.98048 11.725 4.93983 11.6844C4.89918 11.6437 4.86693 11.5955 4.84494 11.5423C4.82294 11.4892 4.81161 11.4323 4.81161 11.3748C4.81161 11.3173 4.82294 11.2604 4.84494 11.2073C4.86693 11.1542 4.89918 11.1059 4.93983 11.0653L9.00584 6.99983L4.93983 2.93436C4.85773 2.85227 4.81161 2.74093 4.81161 2.62483C4.81161 2.50873 4.85773 2.39739 4.93983 2.3153C5.02192 2.23321 5.13326 2.18709 5.24936 2.18709C5.36545 2.18709 5.4768 2.23321 5.55889 2.3153L9.93389 6.6903C9.97457 6.73093 10.0068 6.77918 10.0289 6.83229C10.0509 6.88541 10.0622 6.94234 10.0622 6.99983C10.0622 7.05733 10.0509 7.11426 10.0289 7.16737C10.0068 7.22048 9.97457 7.26873 9.93389 7.30936Z" fill="#F5F3EF"/>
              </svg>
            </button>
          </div>
        )}
