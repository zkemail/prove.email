...
// Custom Discord icon using SvgIcon, because Material UI somehow doesn't have a Discord icon??? 
    ...
    >
        ...
        <Box sx={{
            ...
            <Grid container spacing={2}>
                        ...
                        <Grid container spacing={6} justifyContent="flex-end">
                            ...
                            <Grid item>
                                <Grid container justifyContent="center" spacing={2}>
                                    <Grid item>
                                        <Link href="https://twitter.com/zkemail?lang=en" target="_blank" color="inherit" underline="none">
                                            <TwitterIcon style={{ color: 'white' }} />
                                        </Link>
                                    </Grid>
                                    <Grid item>
                                        <Link href="https://t.me/zkemail" target="_blank" color="inherit" underline="none">
                                            <TelegramIcon style={{ color: 'white' }} />
                                        </Link>
                                    </Grid>
                                    <Grid item>
                                        <Link href="https://discord.com/invite/yourlink" target="_blank" color="inherit" underline="none">
                                            <DiscordIcon style={{ color: 'white' }} />
                                        </Link>
                                    </Grid>
                                    <Grid item>
                                        <Link href="https://www.youtube.com/yourchannel" target="_blank" color="inherit" underline="none">
                                            <YouTubeIcon style={{ color: 'white' }} />
                                        </Link>
                                    </Grid>
                                    <Grid item>
                                        <Link href="https://github.com/zkemail" target="_blank" color="inherit" underline="none">
                ...
                <Grid item xs={12} >                
                    <Typography variant='h1' color="white" textAlign="left"
                    sx={{
                        gridColumn: "div 1",
                        fontSize: {
                            xs:"150px",
