...
//                   transition: 'transform 0.3s ease-in-out',
//                   '&:hover .MuiCardMedia-root': {
//                     transform: 'translateY(0)', // Move the video to the top
//                   },
//                   '& .MuiCardMedia-root': {
//                     transform: 'translateY(100%)', // Initially hide the video
//                     transition: 'transform 0.3s ease-in-out',
//                   },
//                   '&:hover .MuiCardContent-root': {
//                     transform: 'translateY(-100%)', // Move the text to the bottom
//                     transition: 'transform 0.3s ease-in-out',
//                   },
//                   '& .MuiCardContent-root': {
//                     transform: 'translateY(0)', // Initial position
...
//                 cursor: 'pointer',
//                 position: 'relative',
//                 height: '235px', // Set a fixed height for the card
//                 overflow: 'hidden',
//                 transition: 'transform 0.3s ease-in-out',
//                 '&:hover .MuiCardMedia-root': {
//                   opacity: 1,
...
//                 },
//                 '&:hover .MuiCardContent-root': {
//                   height: '30%', // Reduce height on hover
...
//                 image={video.thumbnail}
//                 title={video.title}
//                 sx={{ width: '100%', height: '70%', position: 'absolute', top: 0, left: 0 }}
//                 className="MuiCardMedia-root"
//               />
//               <CardContent 
//                 className="p-4 grid grid-rows-3 grid-cols-2 bg-black relative"
//                 sx={{
//                   position: 'absolute',
//                   bottom: 0,
//                   width: '100%',
...
//                 <Stack direction="row" alignItems='center' sx={{ paddingTop: "16px", paddingY:'12px', justifyItems:'center'}}>
//                   <FiberManualRecord sx={{ color: theme.palette.secondary.main, fontSize: '10px', position: 'relative' }} />
//                   <Typography sx={{fontSize: {xs:'7px', sm:'10px',md:'14px'}, color:'grey',paddingLeft: {xs:'1px', sm:'3px' }}}>Talks</Typography>
//                 </Stack>
//                 <Typography variant="h5" sx={{ color: 'white', gridColumn: 'span 2', fontSize: {xs:'10px', sm: '12px', md: '12.5px', lg:'13px'} }}>
//                   {video.title}
//                 </Typography>
//                 <Grid item xs={12} sx={{ gridColumn: 'span 2' }}>
//                   <Grid container sx={{ justifyContent: 'space-between', alignItems: 'center' }}>
